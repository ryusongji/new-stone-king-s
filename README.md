![header](https://capsule-render.vercel.app/api?type=shark&color=auto&height=200&section=header&text=NEW-STONE-KING'S&fontSize=50)
...
🗨 김지환⬜
    ...
    - 탈부착 형식 방식에 대해 의문점 제시
    - 양면 선풍기 제시
    - 전자파 전문가 의견을 근거로 논쟁 제지
    - 스마트폰 cpu 쿨러 정보 전달
    - 결론정리
